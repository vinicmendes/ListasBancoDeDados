...
#QUESTAO 3 C
SELECT nm_pac
FROM paciente p JOIN atendimento a ON a.cd_pac = p.cd_pac
WHERE dia_atend = "1996-04-09";
...
FROM paciente p
WHERE (SELECT COUNT(*) FROM atendimento a WHERE a.cd_pac = p.cd_pac) > 2;
